...
--vim.keymap.set('i', '##', '#')
--vim.keymap.set('i', '#(', '()<Esc>ha', { desc = 'auto closing ()' })
--vim.keymap.set('i', '#"', '""<Esc>ha', { desc = 'auto closing ""' })
--vim.keymap.set('i', "#'", "''<Esc>ha")
--vim.keymap.set('i', '#<Tab>', '[]<Esc>ha', { desc = 'auto closing []' })

--jdbc:oracle:thin:@10.25.137.54:1521:xe
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("v", "<space>sm", function()
	...
	{ -- LSP Configuration & Plugins
		...
		dependencies = {
			...
			{ "williamboman/mason-lspconfig.nvim", opts = { ensure_installed = { "gopls", "rust_analyzer" } } },
	...
	},
	{
		...
		--		--['<C-k>'] = { 'scroll', { '-0.10', 'false', '100', [['sine']] } },
		--		--['<C-j>'] = { 'scroll', { '0.10', 'false', '100', [['sine']] } },
	...
	--  'wfxr/minimap.vim',
	--  config = function()
	--    vim.g.minimap_block_filetypes = { 'sql', 'psql', 'dbout' }
	--    vim.g.minimap_block_buftypes = { 'sql', 'psql', 'dbout' }
	--  end,
	--},
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- Add/delete/reDBRepositoryplace surroundings (brackets, quotes, etc.)
			--
